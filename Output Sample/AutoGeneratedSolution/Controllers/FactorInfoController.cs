...
namespace AutoGeneratedSolution.Controllers
{
    ...
    public class FactorInfoController : BaseApiController
    {
        ...
        {
            filter = filter == null ? new FactorInfoListFilter() : filter;
        ...
        {
            filter = filter == null ? new FactorInfoPaginationFilter() : filter;
        ...
        {
            filter = filter == null ? new FactorInfoFilter() : filter;
