...
{
    public class FactorInfoSqlData : BaseSqlData<FactorInfoFilter, FactorInfoListFilter, FactorInfoPaginationFilter, FactorInfoAdd, FactorInfoUpdate, BaseSpName>
    {
        public FactorInfoSqlData(string entityName, BaseSpName spNames) : base(entityName, spNames)
        {
            _spNames.EntityName = entityName;
        }

        public override async Task<string> Count(FactorInfoFilter filter)
        {
        ...
        public override async Task<string> ToList(FactorInfoListFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> PagedList(FactorInfoPaginationFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> GetDeletedList(FactorInfoListFilter filter)
        {
        ...
        public override async Task<string> FirstOrDefault(FactorInfoFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> DeletedFirstOrDefault(FactorInfoFilter filter)
        {
			filter.IsDeleted = true;
        ...
        public override async Task<string> AutoComplete(FactorInfoListFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> Add(FactorInfoAdd item)
        {
        ...
        public override async Task<string> Update(FactorInfoUpdate item)
        {
			item.IsDeleted = false;
			item.ModifyDate = DateTimeOffset.Now;
