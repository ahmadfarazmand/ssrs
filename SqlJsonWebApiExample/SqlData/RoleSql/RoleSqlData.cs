...
{
    public class RoleSqlData : BaseSqlData<RoleFilter, RoleListFilter, RolePaginationFilter, RoleAdd, RoleUpdate, BaseSpName>
    {
        public RoleSqlData(string entityName, BaseSpName spNames) : base(entityName, spNames)
        {
            _spNames.EntityName = entityName;
        }

        public override async Task<string> Count(RoleFilter filter)
        {
        ...
        public override async Task<string> ToList(RoleListFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> PagedList(RolePaginationFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> GetDeletedList(RoleListFilter filter)
        {
        ...
        public override async Task<string> FirstOrDefault(RoleFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> DeletedFirstOrDefault(RoleFilter filter)
        {
			filter.IsDeleted = true;
        ...
        public override async Task<string> AutoComplete(RoleListFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> Add(RoleAdd item)
        {
        ...
        public override async Task<string> Update(RoleUpdate item)
        {
			item.IsDeleted = false;
			item.ModifyDate = DateTimeOffset.Now;
