...
{
    public class TempCardItemSqlData : BaseSqlData<TempCardItemFilter, TempCardItemListFilter, TempCardItemPaginationFilter, TempCardItemAdd, TempCardItemUpdate, BaseSpName>
    {
        public TempCardItemSqlData(string entityName, BaseSpName spNames) : base(entityName, spNames)
        {
            _spNames.EntityName = entityName;
        }

        public override async Task<string> Count(TempCardItemFilter filter)
        {
        ...
        public override async Task<string> ToList(TempCardItemListFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> PagedList(TempCardItemPaginationFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> GetDeletedList(TempCardItemListFilter filter)
        {
        ...
        public override async Task<string> FirstOrDefault(TempCardItemFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> DeletedFirstOrDefault(TempCardItemFilter filter)
        {
			filter.IsDeleted = true;
        ...
        public override async Task<string> AutoComplete(TempCardItemListFilter filter)
        {
			filter.IsDeleted = false;
        ...
        public override async Task<string> Add(TempCardItemAdd item)
        {
        ...
        public override async Task<string> Update(TempCardItemUpdate item)
        {
			item.IsDeleted = false;
			item.ModifyDate = DateTimeOffset.Now;
